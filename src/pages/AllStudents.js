import {
  ...
  import {BiLike, BiChat, BiBrush} from "react-icons/bi";
...
<Heading marginBottom={"3%"} marginTop={"3%"}>FILIERE : IITE1</Heading>
        <Grid templateColumns='repeat(3, 1fr)' gap={6}>    
...
<Heading marginBottom={"3%"} marginTop={"3%"}>FILIERE : IITE2</Heading>
        <Grid templateColumns='repeat(3, 1fr)' gap={6}>    
...
<Heading marginBottom={"3%"} marginTop={"3%"}>FILIERE : IITE3</Heading>
        <Grid templateColumns='repeat(3, 1fr)' gap={6}>    
